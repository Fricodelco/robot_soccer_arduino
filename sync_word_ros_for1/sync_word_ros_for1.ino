...
void setup() 
{
  ...
  for (int cnt = 0; cnt < 6; cnt++)
  {
    ...
    dxl_wb.jointMode(dxl_id[cnt], 250, 200); 
  }
...
void  M_R(int w1, int w2){
  ...
  setMotors(-90,90,-68,68,-14,14,-45,45,-3,3,-70,70,-103,103,51,-51,-1,1,y,x,100);
}
...
void  TURN_R(int w1, int w2, bool ifsee){
  ...
  setMotors(-90,90,-68,68,-14,14,-45,45,-5,5,-72,72,-103,102,51,-51,-1,1,y,x,200);
  for(int i = 0;i<10;i++)
    if(ifsee == true)setMotors(-90,90,-68,68,-14,14,-45,45,-5,5,-70,70,-103,102,51,-51,-1,1,y,x,25);
}
...
void F_Shoot_R(int w1, int w2){
 setMotors(-90,90,-68,68,-14,14,-45,45,-5,5,-70,70,  -103,102,51,-51,-1,1,y,x,300);
   setMotors(-90,90,-68,68,-14,14,-45,45,-1,12,-70,68,-102,100,20,-51, -8,-13,y,x,1000);
   setMotors(-90,90,-68,68,-14,14,-45,45,-1,15,-80,68,-120,100, -10,-51, -10,-13,y,x,600);
  setMotors(-90,90,-68,68,-14,14,-45,45,-1,15,-110,65,-90,102, -30,-51, -10,-13,y,x,700);
  setMotors(-90,90,-68,68,-14,14,-45,45,-1,15,-100,65,-90,102, 0,-51, -10,-13,y,x,200);
  setMotors(-90,90,-68,68,-14,14,-45,45,-1,12,-80,68,-120,100, 30,-51, -10,-14,y,x,400);
  setMotors(-90,90,-68,68,-14,14,-45,45,-5,5,-70,70,-100,100,51,-51,-1,1,y,x,1500);
}
void F_Shoot_L(int w1, int w2){
  setMotors(-90,90,-68,68,-14,14,-45,45,-5,5,-70,70,-103,102,51,-51,-1,1,y,x,300);
   setMotors(-90,90,-68,68,-14,14,-45,45,-12,1,-70,70,-102,100, 51,0,8,15,y,x,1000);
   setMotors(-90,90,-68,68,-14,14,-45,45,-15,1,-68,82,-100,120, 51,-10, 13,10,y,x,600);
  setMotors(-90,90,-68,68,-14,14,-45,45,-15,1,-65,110,-102,90, 51,30, 14,10,y,x,700);
  setMotors(-90,90,-68,68,-14,14,-45,45,-15,1,-65,100,-102,90, 51,-30, 14,10,y,x,200);
  setMotors(-90,90,-68,68,-14,14,-45,45,-12,1,-68,82,-100,120, 51,-30, 14,10,y,x,400);
  setMotors(-90,90,-68,68,-14,14,-45,45,-5,5,-70,70,-100,100,51,-51,-1,1,y,x,1500);
}
...
void CIRCLE_RIGHT(int w1, int w2){
  ...
  setMotors(-90,90,-68,68,-14,14,-45,45,-5,5,-70,70,-103,102,51,-51,-1,1,w2,w1,300);
}
void CIRCLE_LEFT(int w1, int w2){
  ...
  setMotors(-90,90,-68,68,-14,14,-45,45,-5,5,-72,72,-103,102,51,-51,-1,1,y,x,300);
}
